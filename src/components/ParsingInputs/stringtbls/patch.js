...
skillxname42, 
skillxsd42, 
skillxld42,lowers enemy lightning resistances for a short duration\nof all nearby enemies\ncreates an electrical field that reduces life
skillxan42, 
skillxname43, 
skillxsd43, 
skillxld43, 
...
skillxname124, 
skillxsd124, 
skillxld124,the souls of slain enemies to give you mana\nwhen active, aura attempts to redeem
skillxan124, 
skillxname125, 
skillxsd125, 
skillxld125, 
...
x,SEND
x,PASSWORD WARNING
x,You cannot send your password to another user on Battle.net. Blizzard will never ask you for your password for any reason.
x,CONNECTING...
x,Diablo II was unable to connect to the realm server. The realm you selected may be unavailable or you may be encountering connection issues. Please make sure your internet connection is working properly and/or your firewall has port 6112 opened.
x,More...
...
x,Entering your email address will enable extra features, such as the ability to recover your account should you forget your password. Visit www.battle.net/email-address for more information.
x,Email Address:
...
x,The password you entered is incorrect.  You can get a new password by clicking 'Account Settings'.
x,ACCOUNT SETTINGS
x,Account Settings
...
x,If you need to change your registered email address, click here.
x,GET NEW PASSWORD
x,Get New Password
x,CHANGE EMAIL
x,Change Email
x,Old Email Address:
x,New Email Address:
x,Verify New Email Address:
x,If you registered an email address for this account then you can change it here. Note that both email addresses need to be active for you to make this change.
x,The old and new email addresses you have entered are the same.  Please enter a different email address.
x,Please make sure that the two new email addresses match.
x,Battle.net News Updates
x,Last Difficulty Setting Completed:
x,None
x,ENTER CHAT
x,PLEASE WRITE DOWN YOUR PASSWORD.
x,Unsafe Password
x,The password you've chosen is unsafe. Please choose a new one.
x,CDKEY WARNING
...
x,Persistent ignoring is now enabled.
x,Persistent ignoring is now disabled.
x,%s has been ignored.
x,Unable to ignore %s
x,%s has been unignored.
x,%s is not currently ignored.
x,Message filter added.
x,Unable to add message filter.
x,Message filter removed.
x,Unable to remove message filter.
Blink,Blink
splash3,Melee Attacks Deal Splash Damage
StrCorrupted,\red;Corrupted
wss,\purple;Worldstone Shard\white;
StrCorruptNum,Corrupt
BloodRavenZombie,Revived Dead
StrEndless,\grey;Quiver
BlinkDesc,instantly moves to a destination
StrUIArcher,Archer
NecroArcher,Necroarcher
MapPlayHave,Players have
MapMonHave,Monsters have
MapGlobHas,Map has
MapGlobLevel,to Area Level
MapGlobDensity,\grey;Monster Density:\blue;
MapGlobMonRarity,\grey;Monstery Rarity:\blue;
MapMonVelocity,increased Velocity
MapMonCurse,Curse Duration Reduction
imma,\gold;Arcane Orb
imrn,\gold;Demonic Cube
imra,\gold;Zakarum Orb
rera,\gold;Horadrim Orb
scou,\gold;Orb of Destruction
upma,\gold;Angelic Orb
...
of Preservation,of Preservation
of Cracking,of Cracking
of Crumbling,of Crumbling
of Disintegration,of Disintegration
Promoted,Promoted
Elevated,Elevated
Ascended,Ascended
of Resilience,of Resilience
of Hardiness,of Hardiness
of Fortitude,of Fortitude
of Imbalance,of Imbalance
of Inequality,of Inequality
of Uneveness,of Uneveness
of Fumbling,of Fumbling
of Bumbling,of Bumbling
of Blundering,of Blundering
of Sturdiness,of Sturdiness
of Stability,of Stability
of Vigor,of Vigor
of Crimson,of Crimson
of Tangerine,of Tangerine
of Opal,of Opal
of Azure,of Azure
...
of Renewal,of Renewal
of Rebirth,of Rebirth
of the Leech,of the Leech
of the Parasite,of the Parasite
of the Bloodsucker,of the Bloodsucker
of Health,of Health
of Vitality,of Vitality
of Vim,of Vim
of Hindrance,of Hindrance
of Aversion,of Aversion
of Permeability,of Permeability
ModStrRepCharge1,Replenish 1 Charge in 8 Seconds
MapGlobMF,\grey;Magic Find:\blue;
MapGlobExp,\grey;Experience:\blue;
MapGlobGF,\grey;Gold Find:\blue;
MapGlobMFGF,\grey;Magic and Gold Find:\blue;
MapTier,Tier:
MapMon,Monster's
MapMonSplash,Melee Attacks Deal Splash Damage
MapEnhancedDmg,Enhanced Physical Damage
MapMonTake,Monsters take
MapPlayAllRes,to All Resistances
MapPlayBlock,Chance to Block
MapFlatPhysRed,Reduced Physical Damage
MapAtkCastRate,Increased Cast and Attack Speed
MapMaxHP,Increased Maximum Life
MapPierceAR,Attack Rating and Chance to Pierce
ModStrRepCharge2,Charges per 100 seconds (do math)
ModStrFireskills,to Fire Skills
ModStrColdskills,to Cold Skills
ModStrLightningskills,to Lightning Skills
ModStrPoisonskills,to Poison Skills
ModStrMagicskills,to Magic Skills
ModPierceChance,Chance to Pierce
ModLeapSpeed,to Leap and Leap Attack Movement Speed
ModReduceCurseDuration,Reduced Curse Duration
ModItemHPaH,Life after each Hit
StrPhysPierce,Physical Pierce: 
ChainLtngSentry,Chain Lightning Sentry
ChainLtngSentrySD,a trap that emits chain lightning
ChainLtngSentryLD,to scorch passing enemies\na trap that shoots chain lightning
ChainLtngSentryS,Chain Ltng. Sent.
MapPhysExtraLtng,of Physical Damage as Extra Lightning Damage
MapPhysExtraCold,of Physical Damage as Extra Cold Damage
MapPhysExtraFire,of Physical Damage as Extra Fire Damage
MapPhysExtraPois,of Physical Damage as Extra Poison Damage over 5 Seconds
MapPhysExtraMag,of Physical Damage as Extra Magic Damage
MapAddMonDoll,Map contains Stygian Dolls
MapAddMonSucc,Map contains Succubus Witches
MapAddMonVamp,Map contains Vampire Lords
MapAddMonCow,Map contains Hell Bovines
MapAddMonHorde,Map contains Reanimated Horde
MapAddMonGhost,Map contains Ghosts
Sparking,Sparking
...
Ghastly,Ghastly
StrExtraBonespear,Bonespear Now Fires
StrExtraBonespear2,Additional Spears
StrExtraRevives,You May Now Summon
StrExtraRevives2,Additional Revives
ModPhysPierce,to Enemy Physical Resistance
Infernal Spire,Infernal Spire
Wisp Boss,\gold;Wisp Boss
Megademon Boss,\gold;Lieutenant of Sin
Fingermage Boss,\gold;Fingermage Boss
immune minion,Immune while Boss is Alive
Unraveler Boss,\gold;Karvarousku the Cartographer
ModVelocity,to Velocity
lbox,\gold;Larzuk's Puzzlebox
StrNearbyEnemies,Nearby Enemies: 
StrFirstHitBonus,First Hit Bonus Damage: 
ForceMove,Move Only
ForceMoveShort,Move to target location
ForceMoveLong,Move to target location
StrAvunaos,\gold;Avunaos the Rotten
StrBelial,\gold;Belial Lord of Lies
StrBolts,Bolts Fired: 
StrLifeHeal,Life Recovered: 
`;
