...
D2bnetHelp10,\blue;Blue Text\gold; represents actions that have been taken by people in the chat Channel or special messages sent directly from battle.net.
...
D2bnetHelp12c,When using advanced commands, you must use battle.net account names; referencing Diablo II character names will not work.
D2bnetHelp12b,To find the account name associated with a character, hold your mouse over that character or access the Character Profile by right clicking the character portrait.
...
CompletingForgottenTPal,I've earned the right to this abandoned trove.
...
FindingJadeFigAma,What would this bring from the right buyer?
FindingJadeFigAma,What a strange little statue.
FindingJadeFigAma,Perhaps I could trade this for something more valuable?
FindingJadeFigAma,I don't sense any magic about this item. Very strange.
...
FreezingIzualAma,Wait... Don't I get three wishes?
...
Nagelring,Nagelring
Manald Heal,The Eye of Mordini
...
ModStr2t,Magic Damage Taken Reduced by
ModStr2u,Physical Damage Taken Reduced by
...
ModStr3w,Damage Taken Gained as Mana when Hit
...
StrSkill41, damage
StrSkill42,Life: 
StrSkill43,Improved Missile Damage
StrSkill44, skeletons total
...
skillld11,always hits\nmagically enhances your arrows or bolts with cold
...
skillname13,Dodge
skillsd13,also grants bonus faster hit recovery\npassive - dodges melee and ranged attacks
...
skillsd14,adds lightning damage and casts a small nova
...
skillan16,Exploding
skillname17,Slow Movement
skillsd17,slows ranged attacks and movement of enemies
skillld17,their ranged attacks and movement\nilluminates nearby enemies and slows
skillan17,Slow Movement
skillname18,Avoid
...
skillan18,Avoid
skillname19,Javelin and Spear Mastery
skillsd19,passively increases damage and attack speed
skillld19,javelin and spear class weapons\nincreases damage and critical hit chance with
skillan19,Impale
...
skillld23,passive - increases your attack rating and lowers target defense
skillan23,Penetrate
...
skillan28,Decoy
skillname29,Evade
skillsd29,passive - dodges when moving and increased movespeed
skillld29,Also grants passive movement speed\na melee or missile attack when walking or running\npassive - you have a chance to dodge
skillan29,Evade
skillname30,Fend
...
skillld42,reduces enemy lightning resistance for a short duration\nof all nearby enemies by one fourth\ncreates an electrical field that reduces life
...
skillsd54,instantly moves to destination and reduces damage dealt
skillld54,and reduces the spell damage you deal for 1 second\ninstantly moves to a destination within your line of sight
skillan54,Teleport
...
skillsd60,retaliates against ranged and melee attackers
skillld60,damages melee attackers if you are hit\nin retaliation against ranged attackers\nincreases defense and discharges a blizzard spike
skillan60,Chilling Armor
...
skillld62,fireball to reduce your enemies to ashes\nsummons a multi-headed beast of flame that casts
skillan62,Hydra
...
skillld65,and pierces enemies resistances to cold\npassive - increases the damage of your cold attacks
...
skillsd69,passive - better skeletons
skillld69,velocity of raised skeletons\npassive - increases life, damage, and
skillan69,Skeleton Mastery
skillname70,Raise Skeleton Warrior
...
skillsd79,Enhances Speed, Life and Number of Golems
...
skillsd84,summons deadly spikes of bone
skillld84,summons deadly spikes of bone to impale your enemies
skillan84,Bone Spear
skillname85,Blood Golem
skillsd85,a golem that shares life
skillld85,with you the life it steals\ncreates a golem that shares
...
skillld87,movement speed, attack rate, and cast rate\ncurses a group of enemies to slow their
skillan87,Decrepify
...
skillld99,them life from melee attacks\nthe life of you and your party and grants\nwhen active, aura slowly regenerates
skillan99,Prayer
skillname100,Resist Fire
skillsd100,fire damage dealt\naura - protects against fire damage and increases
skillld100,for you and your party\nreceived and increases fire damage dealt\nwhen active, aura decreases fire damage
skillan100,Resist Fire
skillname101,Holy Bolt
skillsd101,divine energy that damages enemies and heals allies
skillld101,fires an additional holy bolt at levels 15 and 25\nthat damages enemies or heals allies\na bolt of divine energy
...
skillld104,physical damage reduction of you and your party\nwhen active, aura increases the defense rating and
skillan104,Defiance
skillname105,Resist Cold
skillsd105,cold damage dealt\naura - protects against cold damage and increases
skillld105,for you and your party\nreceived and increases cold damage dealt\nwhen active, aura decreases cold damage
...
skillsd110,lightning damage dealt\naura - protects against lightning damage and increases
skillld110,for you and your party\nreceived and increases lightning damage dealt\nwhen active, aura decreases lightning damage
...
skillsd119,aura - repels and damages enemies with magic
skillld119,provides enhanced damage to attacks against undead\nenemies with magic\nwhen active, aura damages the nearby
...
skillsd124,aura - redeems the dead for mana
...
skillsd125,aura - protects against and increases elemental damage
skillld125,for you and your party\nreceived and increases fire, cold, and lightning damage dealt\nwhen active, aura decreases fire, cold, and lightning damage
skillan125,Salvation
skillname126,Bash
skillsd126,powerful blow that increases damage
skillld126,powerful blow that has a chance to knock back enemies
skillan126,Bash
...
skillname128,General Mastery
skillsd128,passive - improves sword, axe, and mace fighting skill
skillld128,passive - improves sword, axe, and mace fighting skill
skillan128,General Mastery
...
skillname134,Polearm And Spear Mastery
skillsd134,passive - improves polearm and spear skill
skillld134,passive - improves pole arm and spear skill
skillan134,Polearm And Spear Mastery
...
skillsd140,throw two weapons that bounce to nearby enemies
skillld140,weapons bounce to nearby enemies\nthrowing weapons at the same time\nallows you to throw two different
skillan140,Double Throw
skillname141,Combat Reflexes
skillsd141,passive - increases stamina, hit recovery, and life
skillld141,passive - increases stamina, hit recovery, and life
skillan141,Combat Reflexes
...
skillsd143,leaps and attacks enemies
skillld143,in a radius upon landing\nleaps to and attacks enemies
skillan143,Leap Attack
skillname144,Concentrate
skillsd144,attack that is not interruptible
skillld144,converts physical damage to magic damage\nimproves attack and defense rating and\nattack that is not interruptible and
...
skillld146,enemies defense rating and physical damage resistance\nfearsome cry that decreases
...
skillsd150,creates a frightening totem that buffs allies
skillld150,for you and your party\nthat increases damage and attack rating\nto create a frightening totem\nuse on the corpse of a slain monster
...
skillld152,defense rating and physical damage resistance\nincreases damage and attack rating but decreases\na powerful but reckless attack that
skillan152,Berserk
...
x,OK
x,CANCEL
x,(c) 2000 Blizzard Entertainment
...
x,Your IP Address is: 
x,Click 'Host Game' to make your computer the host for a game. Other players must then enter your IP Address to connect to your computer. Only locally stored characters can be played in a hosted game.
x,Click 'Join Game', then enter the IP Address of the host computer. Only locally stored characters can be played in a hosted game.
x,Cannot detect a valid TCP/IP address.
x,Character Name
x,Hardcore
x,Select Hero Class
x,Skilled with the spear and the bow, she is a very versatile fighter.
x,Summoning undead minions and cursing his enemies are his specialties.
x,He is unequaled in close-quarters combat and mastery of weapons.
x,She has mastered the elemental magicks -- fire, lightning, and ice.
x,He is a natural party leader, holy man, and blessed warrior.
x,Player Not Found
x,CANCEL
x,Create Channel
x,Join Channel
x,Invalid Game Name
x,A Game Already Exists With That Name
x,Server Down
x,Error Creating Game
x,Join Failed
x,Maximum Battle.Net
x,characters reached.
x,Select to create a
x,New Character
x,new open character.
x,new realm character.
x,Select Hero Class
x,There is not enough room on your Hard Disk. Please free up space and then try again.
x,CREATE GAME
x,JOIN GAME
x,CREATE LAN GAME
x,JOIN LAN GAME
...
x,Normal
x,Select Difficulty
x,Hardcore and Normal Characters may not be in the same game.
x,Game does not exist.
x,Game name and password don't match.
x,Game is Full.
x,You do not meet the level restrictions for this game.
x,Are you sure that you want to delete this character? Take note: this will delete all versions of this Character.
x,Open
x,That character name is already taken. Try another.
x,YES
x,NO
x,Please Insert the Diablo II
x,Play Disc
x,Cinematics Disc
x,Connecting to Battle.net
x,Querying gateway
x,Connecting to the fastest server
x,Accessing your account
x,Checking versions
x,Verifying CD-key
x,Getting player profile
x,COMPLETE
x,DOWNLOADING PATCH
x,Terms of Use
x,AGREE
x,DISAGREE
x,There is a new version of the software available. Please completely uninstall your game program, reinstall from your original CD, and reconnect to Battle.net.
x,Unable to connect to Battle.net. If you are using a modem to access your service provider and are not configured for Remote Access, you may have to initiate the connection manually.
x,Your Internet connection is either very poor or is not processing UDP packets through port 6112. You will be able to chat but will not be able to play games. Contact your Internet service provider or your system administrator for assistance with opening this port.
x,This application was installed using a CD Key which is not authorized for Battle.net use.
x,Battle.net is unable to properly identify your application version.
x,For more information, please visit www.battle.net/support/errormessages/
x,Unable to connect to Battle.net.
x,If using a modem, you may need to connect to your Internet Service Provider before connecting to Battle.net. For more information, please visit www.battle.net/support/errormessages/
x,You are using a 16-bit connection to your Internet Service Provider.
x,Battle.net requires a 32-bit connection to the Internet. Please make sure that you are using the most current connection software from your Internet Service Provider.
x,Unable to open a TCP/IP connection. Make sure that OpenTransport is installed correctly. You may also need to connect to your Internet Service Provider before connecting to Battle.net.
x,Please uninstall and then reinstall the application using the CD Key from your CD case. If you still cannot connect to Battle.net, please visit www.battle.net/support/errormessages/
x,There is a new version of software available. Battle.net requires that you use the latest version. Your software will be updated now.
x,The update has been downloaded successfully. Your application will now restart.
x,The update has been interrupted. No changes were made. Please try this process again.
x,Downloading software upgrade.
x,The CD Key that you installed with has been disabled. Please contact Blizzard Entertainment Technical Support for further assistance.
x,Your CD key is currently being used by:
x,Only one registered instance of this application can use your CD key at a time. If your connection to Battle.net was just interrupted, please wait five minutes before trying to connect again.
x,The CD key used to install this application was intended for another product. Please reinstall this application using the correct CD key.
X,The Realm is undergoing renovation. Please try again in 15 minutes.
x,Battle.net Log In
x,To use an existing Battle.net account, enter the information below and click 'Log In'. Otherwise, click 'Create New Account'.
x,Account Name Already Exists.
x,The password you have entered is incorrect. Please try again.
x,That account does not exist. If you have not been on Battle.net for 90 days with this account, please select 'Create New Account' to choose a new name and password.
x,That account is corrupted.  Please report this to support@blizzard.com immediately.
x,Server Down
x,Cannot Connect to Server
x,Server Down
x,Server Authorization Failed
x,Name 
x, rejected by Server
x,Account name must be at least 2 characters.
x,Account name can't be more than 15 characters.
x,Passwords don't match.
x,Password must be at least 2 characters.
x,Password can't be more than 15 characters.
x,CREATE NEW ACCOUNT
x,Create Battle.net Account
x,Enter the Name and Password for your new battle.net account.
x,Account Name
x,Password
x,Verify Password
x,PLEASE READ
x,Please note that inactive accounts are deleted at regular times. If you create a new account, you must be logged into Battle.net long enough - either in one session, or spread over several - to have accumulated 2 hours of time within the first 48 hours.
x,After that, your account becomes permanent so long as you continue to log into this account once every 90 days.
x,PLEASE WRITE DOWN YOUR PASSWORD. BLIZZARD DOES NOT HAVE ACCESS TO PASSWORDS, AND CANNOT FIND OR REPLACE FORGOTTEN PASSWORDS.
x,User names must be at least two characters in length. Please try again with a different name.
x,Your user name contained one or more illegal characters.
x,Your user name contained one or more disallowed words.
x,Your previous account creation request is still being processed. Please wait a few moments and try logging in with the account you just created.
x,Your name did not have enough alpha-numeric characters in it.
x,Your name contained too many adjacent punctuation characters in it.
x,Your name contained too many punctuation characters in it.
x,The passwords you have typed do not match. Please enter the same password twice.
x,An account already exists with the name you have chosen.  Please try again with a different name.
x,You have entered an invalid ID.
x,You have entered an incorrect password. If your character has not been on Battle.net for 3 months, or if you forgot your password, you can select 
x,Unable to change password. You have specified an invalid name or password.
x,Please Wait
x,Login Error
x,Unable to Identify Version
x,Reinstall to Upgrade
x,Unable to Connect
x,Battle.net
x,Unable to Create Account
x,Create battle.net Account
...
x,Max. Number of Players:
x,Character Difference:
x,Levels
x,Create/Join Channels
x,Channel Name
x,Channels
x,YES
x,NO
...
x,Game Name
x,Game Name Players
x,Please note that inactive characters are deleted at regular times. You must play a new character at least 2 hours within the first 48 hours.
x,After that, your character may be deleted if you do not play it at least once every 90 days.
x,Played %d days ago
x,
x,Played yesterday
x,Play within %d days
x,to avoid deletion
x,Play within one day
x,Status Unknown
x,May be deleted
x,Character Deleted
x,Player Name
x,LOG IN
x,Select Realm
x,No Realms are available right now, please try again later.
x,Select a Realm from the list below or type the name in the 'Realm Name' box and then click 'OK'.
x,Realm Name
x,Realm List
x,Sort
x,Alphabetically
...
x,connection speed:
x,current capacity:
x,A Realm is a battle.net server that stores Secure characters and runs Secure games with those characters. A Secure character is played in only one Realm.
x,Character Storage Site
x,Secure characters have access to all battle.net features, including Ladders, and chat portraits. You must have a working internet connection to play a Secure character.
x,WARNING: Once a Hardcore character dies, it cannot be played again. Are you sure you wish to create a Hardcore character?
x,You cannot create or join games with a dead hardcore character.
x,SEND
x,WHISPER
x,SQUELCH
x,HELP
...
x,Invalid channel name. A channel name cannot contain reserved characters.
x,You have clicked on a link to the Internet. Your web browser will now be launched. You can use the Windows Taskbar to return to Battle.net.
x,You have disconnected from Battle.net. Press OK to hangup the connection to %s. Press Cancel to stay connected.
x,Battle.net was unable to launch your default browser.
x,Couldn't open this URL. The URL appears to be invalid.
x,Launching a web browser from Battle.net requires Internet Config 1.1 or newer.  Make sure Internet Config is installed on your computer.
x,The default web browser selected in Internet Config or the Internet control panel could not be located on your hard drive.
x,There is not enough free memory available to launch the web browser.
x,You have clicked on a link to the Internet. Your web browser will now be launched. Use 
x,That channel is restricted
x,You were disconnected from battle.net.  Please reconnect.
x,Battle.net is down. Reconnect later.
x,Timed out waiting for response.
x,Battle.net is down. Reconnect later.
x,Lost Connection to battle.net.
x,Your connection to Battle.net has been lost.
x,Battle.net is not responding. Please try connecting again in a few minutes.
x,Battle.net is not responding. Please try connecting again in a few minutes.
x,The connection to Battle.net has been interrupted. Please try again later.
x,You are banned from battle.net. Reconnect later.
x,Your connection has been interrupted
x,The Host of this game has left
x,A dead hardcore character cannot join or create any games.
x,Versions do not match. Please log onto battle.net or go to http://www.blizzard.com/support/Diablo2 to get a patch
x,Unable to enter game. A hardcore character cannot join a game created by a normal character.
x,Unable to enter game. A normal character cannot join a game created by a hardcore character.
x,Unable to enter game. Your character must kill Diablo in Nightmare difficulty to play in a Hell game.
x,Unable to enter game. Your character must kill Diablo to play in a Nightmare game.
x,Unable to enter game. Bad character version
x,Unable to enter game. Bad character quest data
x,Unable to enter game. Bad character waypoint data
x,Unable to enter game. Bad character stats data
x,Unable to enter game. Bad character skills data
x,failed to join game
x,Unable to enter game
x,unknown failure
x,Unable to enter game, Bad inventory data
x,Unable to enter game, bad dead bodies
x,Unable to enter game, bad header
x,Unable to enter game, bad hireables
x,Unable to enter game, bad intro data
x,Unable to enter game, bad item
x,Unable to enter game, bad dead body item
x,Unable to enter game, generic bad file
x,Game is full
dummy,an evil force
Dummy,an evil force
...
t11,Plains of Torment Map
t12,Ancestral Trial Map
t13,Horadrim Tower Map
t14,Sewers of Harrogath Map
t15,Horazon's Memory Map
t16,Ruins of Viz-Jun Map
t17,River of Blood Map
t18,Phlegethon Map
StrJavMastAtkSpd,Increases attack speed by 1% per base level
StrJavMastAtkSpd2,Currently: 
StrPowerStrikeNova,lightning damage in an area\nCasts a small nova that deals
HolyNova,Holy Nova
HolyNovaShortDesc,Creates a Nova of Holy Light
HolyNovaLongDesc,that damages enemies or heals allies\nCreates an expanding ring of holy energy
Physdplev,Physical Damage per Level
HolyLight,Holy Light
HolyLightShortDesc,Heals an Ally
HolyLightLongDesc,to heal an ally from afar\nCalls down light from the heavens
NovaDmgStr,Nova Lightning Damage: 
NovaLtngdplev,Nova Lightning Damage per Level
EnemyAtkRateStr,Enemy Attack Rating: 
SlowMoveStr,Slows Movement by: 
StrPowerStrikeLevel,Powerstrike Level: 
StrValkPowerStrikeSyn,Power Strike: +20% added lightning damage and +10% nova lightning damage
StrExtraValk,at levels 20 and 30\nCan summon an additional valkyrie
StrPercentMoveSpeed,% Movement Speed
StrPercentFHR,% faster hit recovery
StrDodgeFHR,Grants bonus hit recovery per base level
StrLevels, levels
MagdConvplev,Magic Damage Conversion per Level
IceBarrage,Ice Barrage
IceBarrageShortDesc,Creates a barrage of ice lances that slow enemies
IceBarrageLongDesc,that damage and slow nearby enemies\nCreates a barrage of magical ice lances
IceLances, Ice Lances
Ltngprcplev,Lightning Pierce per Level
StrWeaponDmg,Weapon Damage: 
StrFlatLife, life
StrFlatMana, mana
AddedPhysdplev,Added Damage per Level
StrBounces, bounces
StrPercentDamage,% Damage
Gust,Gust
GustShortDesc,Instantly moves to a destination and stuns enemies
GustLongDesc,enemies upon arrival for .2 seconds\nInstantly moves to a destination stunning
StrCooldown,Cooldown: 
BloodWarp,Blood Warp
BloodWarpShortDesc,Instantly moves to a destination and drains life
BloodWarpLongDesc,of a percentage of max HP\nInstantly moves to a destination at the cost
StrLifeCost,Life Cost: 
StrPercentMaxHP,% Maximum HP
StrIncLeapSpeed,Leap speed is increased with each base level
StrPercIncLeapSpeed,% Increased Leap Speed
StrColdPierce,Cold Pierce: 
ColdEnchant,Cold Enchant
ColdEnchantShortDesc,enchants melee or ranged weapons with cold
ColdEnchantLongDesc,adds one-third cold damage to ranged weapons\nadds cold damage to melee weapons\nenchants equipped weapon of targeted character or minion
StrDelay,Delay: 
StrReducedDelay,Reduced Delay
StrAttackRating, Attack Rating
StrPhysDmgResist,Physical Damage Resistance: 
StrBonusSkills,Bonus Skills: 
StrIncPhysDmgRed,By 1% Every 2 Base Levels\nIncreases Physical Damage Reduction
StrPhysDmgRed,Physical Damage Reduction: 
StrIncFlatLife,Increases Max HP By 10 Every Base Level
StrPierce,Pierce: 
Combustion,Combustion
CombustionShortDesc,Creates an expanding ring of fire balls to engulf your enemies
CombustionLongDesc,Creates an expanding ring of fire balls to engulf your enemies
StrFirePierce,Fire Pierce: 
LesserHydra,Lesser Hydra
LesserHydraShortDesc,summons multi-headed fire beast
LesserHydraLongDesc,firebolt to reduce your enemies to ashes\nsummons a multi-headed beast of flame that casts
StrGainDRPassiveBonus,Gain 1% Active Damage Reduction with every 2 Base Level\n
StrPassiveHPRegen,Health Regeneration: 
StrGainRegenPassiveBonus,Grants +1 Passive Health Regeneration per 2 Base Levels
StrEnemyLtngRes,Enemy Lightning Resistances: -
StrLtngMasterySynergy,Lightning Mastery: 
skill charm,skills
exp charm,exp charm
frw charm,gotta go fast
PercWeapDamsk,% Weapon Damage
StrSkillBombs,Bombs: 
StrIncreasedBombs,Gains an Extra Bomb Every 4 Base Levels
StrAddBoneSpear,Fires an Additional Bone Spear at Levels 15 and 25
StrSkillBoneSpears,Bone Spears: 
StrIncVelocity,Velocity: 
StrTwisters,Twisters: 
StrManaHeal,Mana Recovered: 
StrOakSynergy,Oak Sage: 
StrCarrionSynergy,Carrion Vine: 
StrSolarSynergy,Solar Creeper: 
StrLifeHealed, Life Healed per Level
StrManaHealed, Mana Recovered per Level
StrExtraGolems,Can Summon an Extra Golem Every 5 Base Levels
StrGolems,Golems: 
StrExtraRaven,Summon an Additional Raven per Cast every 10 Base Levels
StrHPRegenPerLevel,Health Regeneration per Level
StrReturns,Returns 
StrDmgToAtt, Damage to Attackers
StrMagDmgRed,Magic Damage Reduction: 
CurseMastery,Curse Mastery
CurseMasteryShortDesc,increases the max number of curses
CurseMasteryLongDesc,you to apply an additional curse for every 10 base levels\npassive - provides benefits to your curses and allows
StrMaxCurses,Maximum Curses: 
StrCurseDuration,Curse Duration: 
StrCurseRadius,Curse Radius: 
StrLowerResDesc,Lowers Resistances by 2% per Base Level
Desecrate,Desecrate
DesecrateShortDesc,summons 5 corpses and releases a deadly cloud of poison\n
DesecrateLongDesc,summons 5 corpses and releases a deadly cloud of poison
StrAmpDmgPhysRes,Reduced Physical Damage Resistance Increased by 2% per Base Level
StrAttCastRateplev,Reduced Attack and Cast Rate per Level
StrAttCastRate,Attack and Cast Rate: 
StrMoveSpeed,Movement Speed: 
StrRedPhysDmgResplev,Reduced Physical Resistance per Level
StrDecrepRedDesc,Increased by 1% per Base Level\nReduced Movement Speed, Attack Rate, and Cast Rate
StrRedARplev,Reduced Attack Rating per Level
StrIncLLplev,Increased Life Steal per Two Levels
StrLifeTapInc,Percent Life Steal Increases by 1% per Base Level
StrLifeSteal,Life Steal: 
StrRedDmgplev,Reduced Damage per Two Levels
StrConfuseAttSpd,Increases Monster Attack Speed by 3% per Base Level
StrAttSpdplev,Increased Attack Speed per Level
StrRedEneDefplev,Reduced Enemy Defense per Level
StrRedMoveSpdplev,Reduced Movement Speed per Level
StrLowResRedplev,Lowered Resistances per Two Levels
StrIncDmgRet,Increased Damage Returned to Enemies per Level
StrTerrorMoveSpdDesc,Reduces Movement Speed by 2% per Base Level
StrIncRadiusplev,Radius per Three Levels
DarkPact,Dark Pact
DarkPactShortDesc,consumes curses to deal magic damage around the enemy
DarkPactLongDesc,the enemy for each curse devoured\nsealing a dark pact and dealing damage around\nconsumes the curses on enemies within an area
StrAllCurses,All Curses
StrMagDmg,Magic Damage
StrPerCurse, per Curse: 
Joust,Joust
JoustShortDesc,teleport and strike enemies
JoustLongDesc,strike gaining increased movement speed for 2 seconds\nteleport to your enemies and impale them with a deadly
StrDeals,Deals 
StrPercWepDmg,% Weapon Damage
StrJoustIncMS,Increases Movement Speed by 2% per Base Level
StrCritStrike,Critical Strike: 
LesserFade,Lesser Fade
StrToMaxCurses,to Maximum Curses
Blink,Blink
BlinkShortDesc,instantly moves to destination
BlinkLongDesc,instantly moves to a destination
StrConcMagConvert,Converts 2% of Physical Damage to Magic Damage per Base Level
StrLeapDist,Leap Distance: 
StrLeapKBDist,Knockback Radius: 
StrPercTargetDef,% to Target Defense
StrPenTgtDef,Reduces Target Defense by 1% per Base Level
StrPercPoisRes,% Poison Resistance
StrPierces,Pierces 
StrBOSAtkSpd,Increases Attack Speed with Base Levels
StrVelocity,Velocity: 
StrElemDmg,Elemental Damage: 
StrLGOH, Life Gained On Hit
StrNecroMagePsn, Over 0.5 Seconds
StrBCSkills,Grants an Additional Skill Level every 10 Base Levels
StrMaxFireResPassive,Grants 1% Passive Maximum Fire Resistance per 2 Base Levels
StrMaxColdResPassive,Grants 1% Passive Maximum Cold Resistance per 2 Base Levels
StrMaxLtngResPassive,Grants 1% Passive Maximum Lightning Resistance per 2 Base Levels
StrToMaxFireRes,Maximum Resist Fire: 
StrToMaxColdRes,Maximum Resist Cold: 
StrToMaxLtngRes,Maximum Resist Lightning: 
StrPassiveDR,Passive Physical Damage Reduction: 
StrActiveDR,Active Physical Damage Reduction: 
StrPassiveMoveSpeed,Grants +1% Passive Faster Run/Walk per Base Level
StrFRW,Faster Run/Walk: 
StrPoisDurRed,Reduces poison duration by 
StrDurRedPassive,Grants 1% Passive Reduced Duration of Poison and Curses per 2 Base Levels
StrMedMPK,Grants +1 Passive Mana After Each Kill per 5 Base Levels
StrMPK, to Mana after each Kill
StrPassiveBlessAim,Grants +10% Passive Attack Rating per Base Level
StrHungerBuffs,Gains +1 Second Duration and +1% Movement Speed per Base Level
StrCritStrikeChance, percent chance of Critical Strike
`;
